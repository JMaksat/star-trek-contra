...
public class Framework extends Canvas {
     ...
     */
    public static enum GameState{STARTING, VISUALIZING, GAME_CONTENT_LOADING, MAIN_MENU, OPTIONS, GAME, GAMEOVER, DESTROYED}
    /**
   ...
   /**
    ...
    private void LoadContent()
    {
        try 
        {
            URL menuBorderImgUrl = this.getClass().getResource("/res/intro.jpg");
            menuBorderImg = ImageIO.read(menuBorderImgUrl);
            
            URL gameTitleImgUrl = this.getClass().getResource("/res/TITLE.png");
    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case GAMEOVER:
                ...
                g2d.setFont(font);
                g2d.drawString(game.getFinalResult(), frameWidth/2 - 70, frameHeight/8);
            break;
            case MAIN_MENU:
                drawMenuBackground(g2d);
                g2d.drawImage(gameTitleImg, frameWidth / 2 - gameTitleImg.getWidth() / 2, frameHeight / 10, null);
                g2d.setColor(Color.WHITE);
                g2d.drawString("Use arrow keys to move the spaceship. Use space for fire.", frameWidth / 2 - 160, frameHeight / 3 - 27);
                g2d.drawString("Do not miss the earth spaceships.", frameWidth / 2 - 100, frameHeight / 3 - 13);
                g2d.drawString("Press any key to start the game or ESC to exit.", frameWidth / 2 - 133, frameHeight / 3);
            break;
            case OPTIONS:
                //...
            break;
    ...
    private void drawMenuBackground(Graphics2D g2d){
        ...
        g2d.setColor(Color.white);
        g2d.drawString("Program is for non commercial use. Maksat E.", 7, frameHeight - 5);
    }
}
